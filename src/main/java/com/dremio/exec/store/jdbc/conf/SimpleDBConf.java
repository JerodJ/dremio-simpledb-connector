...
@SourceType(value = "SimpleDBARP", label = "SimpleDB",uiConfig = "simpledb-layout.json")
public class SimpleDBConf extends AbstractArpConf<SimpleDBConf> {
  private static final String ARP_FILENAME = "arp/implementation/simpledb-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.simpledb.SimpleDBDriver";
